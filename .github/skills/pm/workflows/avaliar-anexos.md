...
4. Use o `pm-analista` para classificar cada arquivo como `Projeto`, `Historia` ou `Implementacao`.
5. Entregue a analise ao `pm-operador` para preencher [inventario-anexos.md](../assets/inventario-anexos.md).
